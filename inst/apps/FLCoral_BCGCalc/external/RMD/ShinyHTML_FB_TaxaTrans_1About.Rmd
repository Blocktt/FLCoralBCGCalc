...
2.  Appends the Florida taxa attributes, which include phylogenetic data
    ...
    assignments (BCG_ATTR), whether the taxon is \'Sometimes\' or
    \'Never\' weedy (WEEDY), whether the taxon is a \'Large
    Reef-Building Coral\' (LRBC), and the Morphological Conversion
    Factor (MORPHCONVFACT) which is used to calculate Live tissue area
    on Colony Surface Area (LCSA).
...
Translator, Taxa Attributes, and Metadata</a> from Github.
...
<a href="https://raw.githubusercontent.com/Blocktt/ShinyAppDocuments/main/NM_BCGCalc/Example_Files/NM_BCG_Fish_Count_Data_20240111.csv" target="_blank">Example
